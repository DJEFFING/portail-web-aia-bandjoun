        ...
        <div class="pd-ltr-20 xs-pd-20-10">
            <div class="min-height-200px">
                <div class="page-header">
                    <div class="row">
                        <div class="col-md-6 col-sm-12">
                            <div class="title">
                                <h4>Ajouter Un Dommaine de Recherche</h4>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <form class="html-editor pd-20 card-box mb-30" method="POST" action="{{ route('admin.poleRecherche.store') }}" enctype="multipart/form-data">
                    <h4 class="h4 text-blue">Ce formulaire Permet D'ajouter un nouveau Dommaine de Recherche</h4>
                    @csrf
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Code : </label><span class="text-danger">*</span>
                                <input type="text" name="code_pole" class="form-control" required>
                            </div>
                        </div>
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input type="file" name="media_url" class="form-control" required>
                        </div>
                    </div>
                    <!--END Image -->
