    ...
    <div class="menu-block customscroll">
        <div class="sidebar-menu">
            <ul id="accordion-menu">
                ...
                <li><a href="/admin" class="dropdown-toggle no-arrow"><span class="micon dw dw-house-1"></span>Tableau De Bord</a></li>

                <li>
                    <center><div class="sidebar-small-cap">Managment Site</div></center>
                </li>
