    ...
    <div class="main-container">
        <div class="pd-ltr-20 xs-pd-20-10">
            <div class="min-height-200px">
                ...
                <form class="html-editor pd-20 card-box mb-30" method="POST" action="{{ route('admin.publication.update',$publication->id) }}"
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input type="text" value="{{ $publication->titre }}" name="titre" class="form-control"
                                required>
                        </div>
                    </div>
                            ...
                            <select class="custom-select2 form-control" name="type_publication_id"
                                ...
                                <optgroup label="Revue d'article">
                                    @forelse ($typePublications as $typePublication)
                                        @if ($publication->typePublication->id == $typePublication->id)
                                            <option value="{{ $typePublication->id }}" selected>{{ $typePublication->nom }}
                                            </option>
                                        @else
                            ...
                            <select class="custom-select2 form-control" name="annee_publication_id"
                                ...
                                <optgroup label="Revue d'article">
                                    @forelse ($anneePublications as $annee)
                                        @if ($currentAnnee->id == $annee->id)
                                            <option value="{{ $annee->id }}" selected>{{ $annee->annee_publication }}
                                            </option>
                                        @else
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <textarea name="description_1" id="" class="form-control" required>{{ $publication->description_1 }}</textarea>
                        </div>
                    </div>
                    <!--END description -->
                    ...
                    <textarea class="textarea_editor form-control border-radius-0" name="description_2" placeholder="Enter text ..."
                        required>{{ $publication->description_1 }}
                    </textarea><br>
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input type="text" value="{{ $publication->lien_externe }}" placeholder="https://www.youtube.com/" name="lien_externe"
                                class="form-control">
                        </div>
                    </div>
