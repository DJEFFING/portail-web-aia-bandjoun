                        ...
                        <tbody>
                            ...
                            @forelse ($slides as $slide)
                                <tr>
                                    ...
                                    @include('admin.slide.show', [
                                        'id' => $slide->id,
                                        'item' => $slide,
                                    ])

                                    @include('admin.slide.update', [
                                        'id' => $slide->id,
                                        'item' => $slide,
                                    ])
                                    {{-- @include('admin.global-modal.delete-modal', [
                                        'id' => $slide->id,
                                        'url' => route('admin.slide.delete', $slide->id),
                                    ]) --}}
