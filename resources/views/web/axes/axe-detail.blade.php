        ...
        <section id="service-details" class="service-details">
            <div class="container" data-aos="fade-up" data-aos-delay="100">
                ...
                <div class="row gy-4">
                    ...
                    <div class="col-lg-8">
                        <img src="{{ asset('storage/'.$axe->media_url) }}" alt="" class="img-fluid services-img">
                        <h3>{{ $axe->titre }}</h3>
                    ...
                    <div class="col-lg-4" >
                        <div class="card" style="padding: 20px;">
                            ...
                            <div class="row">
                                ...
                                <img src="{{ asset('storage/'.$axe->user->profil_url) }}" class="p-3 card-img-top rounded-circle img-fluid w-50 h-100" alt="...">
                                @else
